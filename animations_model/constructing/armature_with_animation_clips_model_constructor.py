from animations_model.constructing.armature_with_animation_clips_model_builder import ArmatureWithAnimationClipsModelBuilder
...
class ArmatureWithAnimationClipsModelConstructor:
    def construct_from_json(self, json_dict):
        ...
        for animation_frame_number, animation_clip_name in enumerate(json_dict["animationClips"]):
            result_builder.add_animation_clip(animation_clip_name)
            for animation_frame_dict in json_dict["animationClips"][animation_clip_name]:
